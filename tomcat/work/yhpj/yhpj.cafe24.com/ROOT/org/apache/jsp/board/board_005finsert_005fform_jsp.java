 ...
 * Generated at: 2020-11-28 16:50:38 UTC
...
public final class board_005finsert_005fform_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\tBoardImg_cnt = 0;\n");
      out.write("\t\t\t function BoardImg_AddItem()\n");
      out.write("\t\t\t {\n");
      out.write("\t\t\t\t BoardImg_cnt++;\n");
      out.write("\t\t\t\t BoardImgdiv = document.createElement('BoardImgdiv'); //div id값 받아오는 부분\n");
      out.write("\t\t\t\t BoardImgdiv.className = 'row';\n");
      out.write("\t\t\t\t BoardImgdiv.innerHTML += \"<br><br>\" + \"사진 #\"\n");
      out.write("\t\t\t\t \t+ BoardImg_cnt\n");
      out.write("\t\t\t\t\t+ \"<img name=BoardImg id=BoardImg\"+BoardImg_cnt +\" src='' style='width:70%;align:center;'/>\"\n");
      out.write("\t\t\t\t\t+ \"&nbsp;&nbsp;\"\n");
      out.write("\t\t\t\t\t+ \"<input type=file name=BoardImgFile\"+BoardImg_cnt + \" id=BoardImgPreview\"+ BoardImg_cnt +\" accept='.jpeg, .jpg, .jpe, .jfif, .PNG, .png, .img' />\"\n");
      out.write("\t\t\t\t\t+ \"&nbsp;&nbsp;\"\n");
      out.write("\t\t\t\t\t+ \"<input type=button value='X' onclick='BoardImg_removeRow(this)' style='align:right; font-weight:bold; font-size:10px; height:30px' class='btn btn-primary btn-fill' /> <br><br><hr>\";\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\tdocument.getElementById('BoardImgdiv').appendChild(BoardImgdiv); //Input 값 유지시켜주는 부분\t\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t$(function() {\n");
      out.write("\t\t\t\t\t\t$('#BoardImgPreview' + BoardImg_cnt).on('change', function() {\n");
      out.write("\t\t\t\t\t\t\tReadBoardImgURL(this);\n");
      out.write("\t\t\t\t\t\t}); \n");
      out.write("\t\t\t\t\t});\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t\t\tfunction ReadBoardImgURL(input) {\n");
      out.write("\t\t\t\t\t\tif (input.files && input.files[0]) {\n");
      out.write("\t\t\t\t\t\t\tvar reader = new FileReader();\n");
      out.write("\t\t\t\t\t\t\treader.onload = function(e) {\n");
      out.write("\t\t\t\t\t\t\t\t$('#BoardImg'+ BoardImg_cnt).attr('src', e.target.result);\n");
      out.write("\t\t\t\t\t\t\t}\n");
      ...
      out.write("\t\t\t function BoardImg_removeRow(input)\n");
      out.write("\t\t\t {\n");
      out.write("\t\t\t\t document.getElementById('BoardImgdiv').removeChild(input.parentNode);\n");
      out.write("\t\t\t\t BoardImg_cnt--;\n");
      out.write("\t\t\t }\n");
      out.write("\t\t\t \n");
      ...
      out.write("\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\tvar form = document.BoardForm;\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\tif(!form.Board_Title.value)\n");
      out.write("\t\t\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\t\t\talert(\"제목을 입력해 주세요\");\n");
      out.write("\t\t\t\t\t\t\t\tform.Board_Title.focus();\n");
      out.write("\t\t\t\t\t\t\t\treturn false;\n");
      out.write("\t\t\t\t\t\t\t} else if(!form.Board_Content.value)\n");
      out.write("\t\t\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\t\t\talert(\"내용을 입력해 주세요\");\n");
      out.write("\t\t\t\t\t\t\t\tform.Board_Content.focus();\n");
      out.write("\t\t\t\t\t\t\t\treturn false;\n");
      out.write("\t\t\t\t\t\t\t} else if(form.Board_Title.value.match(\"시발\") || form.Board_Title.value.match(\"꺼져\") || form.Board_Title.value.match(\"개새\") )\n");
      out.write("\t\t\t\t\t\t\t {  \n");
      out.write("\t\t\t\t\t\t\t\t alert(\"제목 욕설 금지\");\n");
      out.write("\t\t\t\t\t\t\t\t document.getElementById(\"Board_Title\").value='';\n");
      out.write("\t\t\t\t\t\t\t\t form.Board_Title.focus();\n");
      out.write("\t\t\t\t\t\t\t\t return false;\n");
      out.write("\t\t\t\t\t\t\t}else if(form.Board_Content.value.match(\"시발\") || form.Board_Content.value.match(\"꺼져\") || form.Board_Content.value.match(\"개새\"))\n");
      out.write("\t\t\t\t\t\t\t {  \n");
      out.write("\t\t\t\t\t\t\t\t alert(\"본문 욕설 금지\");\n");
      out.write("\t\t\t\t\t\t\t\t document.getElementById(\"Board_Content\").value='';\n");
      out.write("\t\t\t\t\t\t\t\t form.Board_Content.focus();\n");
      out.write("\t\t\t\t\t\t\t\t return false;\n");
      out.write("\t\t\t\t\t\t\t}\n");
      ...
      out.write("\t\t\t<form name=\"BoardForm\" id=\"BoardForm\" action=\"board_insert_action.jsp?pg=");
      out.print(pg );
      out.write("\"\n");
      out.write("\t\t\t\tmethod=\"post\" onSubmit=\"return BoardWriteCheck(this);\" enctype=\"multipart/form-data\">\n");
      out.write("\t\t\t\t<div class=\"row\">\n");
      out.write("\t\t\t\t\t<div class=\"col-md-12 col-sm-24\">\n");
      out.write("\t\t\t\t\t\t<div align=\"center\">\n");
      out.write("\t\t\t\t\t\t\t<h1 style=\"font-style: bold;\">소통글작성</h1>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<input type=text id=\"Board_Title\" name=\"Board_Title\" placeholder=\"제목을 입력해 주세요\"\n");
      ...
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-10 col-sm-20\">\n");
      out.write("\t\t\t\t\t\t<textarea id=\"Board_Content\" name=\"Board_Content\" placeholder=\"내용을 입력해 주세요\"\n");
      ...
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-md-10 col-sm-20\">\n");
      out.write("\t\t\t\t\t\t<div id=\"BoardImgdiv\" style=\"align: left;\"></div>\n");
      out.write("\t\t\t\t\t\t<input type=\"button\" value=\"파일 추가하기\" onclick=\"BoardImg_AddItem()\"\n");
