 ...
 * Generated at: 2020-11-22 08:42:16 UTC
...
return;
    ...
    try {
      ...
      out.write("\tvar form1 = document.joinform;\n");
      out.write("\tvar regex_tel = /^(?:(010-?\\d{4})|(01[1|6|7|8|9]-?\\d{3,4}))-?\\d{4}$/;\n");
      out.write("    var regex_email = /^[-A-Za-z0-9_]+[-A-Za-z0-9_.]*[@]{1}[-A-Za-z0-9_]+[-A-Za-z0-9_.]*[.]{1}[A-Za-z]{1,5}$/;\n");
      out.write("\t\n");
      out.write("\tif(!form1.id.value){\n");
      out.write("\t\talert(\"아이디를 적어주세요\");\n");
      out.write("\t\tform1.id.focus();\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\tif(!regex_email.test(form1['id'].value))\n");
      out.write("\t{\n");
      out.write("\t\talert(\"아이디를 이메일형식(example@naver.com)으로 적어주세요\");\n");
      out.write("\t\tform1.id.focus();\n");
      out.write("\t\treturn false;\n");
      out.write("\t}\n");
      out.write("\t\n");
      out.write("\tvar user_id = form1.id.value;\n");
      out.write("\tvar url = \"/join/idcheck.jsp?id=\" + user_id;\n");
      out.write("\twindow.open(url, \"IdCheck\", \"toolbar=no, location=no, status=no, menubar=no, scrollbar=no, resizable=no, width=600, height=180\");\n");
      out.write("\treturn;\n");
      out.write("}\n");
      out.write("\n");
      out.write("function check_id() {\n");
      out.write("\tvar check = document.joinform;\n");
      out.write("\t\n");
      out.write("\tvar regex_tel = /^(?:(010-?\\d{4})|(01[1|6|7|8|9]-?\\d{3,4}))-?\\d{4}$/;\n");
      out.write("\tvar regex_pw = /^.*(?=^.{8,20}$)(?=.*\\d)(?=.*[a-zA-Z])(?=.*[!@#$%^&+=]).*$/;\n");
      out.write("\n");
      out.write("\t\n");
      out.write("\tif(check['join_name'].value == \"사용가능한 아이디 입니다.\")\n");
      out.write("\t{   \n");
      out.write("\t\tif(check['user_pw'].value != \"\")\n");
      out.write("\t\t{\n");
      out.write("\t\t\tif(regex_pw.test(check['user_pw'].value) == true)\n");
      out.write("\t\t\t{\n");
      out.write("\t\t\t\tif(check['user_pw'].value == check['user_pw_ck'].value)\n");
      out.write("\t\t\t\t{\n");
      out.write("\t\t\t\t\tif(check['user_name'].value != \"\")\n");
      out.write("\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\tif(check['user_tel'].value != \"\")\n");
      out.write("\t\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\t\tif(regex_tel.test(check['user_tel'].value) == true)\n");
      out.write("\t\t\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\t\t\tif(check['user_address'].value != \"\")\n");
      out.write("\t\t\t\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\t\t\t\tif(check['user_promise'].value != \"\")\n");
      out.write("\t\t\t\t\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\t\t\t\t\treturn true;\n");
      out.write("\t\t\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\t\t\telse\n");
      out.write("\t\t\t\t\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\t\t\t\t\talert(\"나의 다짐을입력해주세요.\");\n");
      out.write("\t\t\t\t\t\t\t\t    \tcheck['user_promise'].focus();\n");
      out.write("\t\t\t\t\t\t\t\t\t    return false;\n");
      out.write("\t\t\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\t\telse\n");
      out.write("\t\t\t\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\t\t\t\talert(\"거주지를 입력해주세요.\");\n");
      out.write("\t\t\t\t\t\t\t    \tcheck['user_address'].focus();\n");
      out.write("\t\t\t\t\t\t\t\t    return false;\n");
      out.write("\t\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t\telse\n");
      out.write("\t\t\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\t\t\talert(\"휴대폰 번호를 정확히 입력해주세요(000-0000-0000)\");\n");
      out.write("\t\t\t\t\t\t    \tcheck['user_tel'].focus();\n");
      out.write("\t\t\t\t\t\t\t    return false;\n");
      out.write("\t\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t\telse\n");
      out.write("\t\t\t\t\t\t{\n");
      out.write("\t\t\t\t\t\t\talert(\"휴대폰 번호를 입력해주세요(000-0000-0000)\");\n");
      out.write("\t\t\t\t\t    \tcheck['user_tel'].focus();\n");
      out.write("\t\t\t\t\t\t    return false;\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t}\n");
      ...
      out.write("\t\t\t\t    \tcheck['user_name'].focus();\n");
      out.write("\t\t\t\t\t    return false;\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t\telse\n");
      ...
      out.write("\t\t\t\t\tcheck['user_pw'].value = \"\";\n");
      out.write("\t\t\t\t\tcheck['user_pw_ck'].value = \"\";\n");
      out.write("\t\t\t    \tcheck['user_pw'].focus();\n");
      out.write("\t\t\t\t    return false;\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\telse\n");
      out.write("\t\t\t{\n");
      out.write("\t\t\t\talert(\"비밀번호를 정확히 입력해주세요(8~20자의 영문,숫자,특수문자 조합입니다.)\");\n");
      out.write("\t\t    \tcheck['user_pw'].focus();\n");
      out.write("\t\t\t    return false;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t}\n");
      out.write("\t\telse\n");
      out.write("\t\t{\n");
      out.write("\t\t\talert(\"비밀번호를 입력해주세요(8~20자의 영문,숫자,특수문자 조합입니다.)\");\n");
      out.write("\t    \tcheck['user_pw'].focus();\n");
      out.write("\t\t    return false;\n");
      out.write("\t\t}\n");
      out.write("\t}\n");
      out.write("\telse\n");
      out.write("\t{\n");
      out.write("\t\talert(\"ID 중복체크를 확인해주세요\");\n");
      out.write("    \tcheck['id'].focus();\n");
      out.write("\t    return false;\n");
      out.write("\t}\n");
      out.write("\t\n");
      out.write("}\n");
      ...
      out.write("   <br><div id=\"out\"></div><br>\n");
      out.write("   <div class=\"container contact\" align=\"center\">\n");
      out.write("   <div class=\"col-lg-6\"><h2>회원가입</h2></div>\n");
      out.write(" 기본 정보 입력\n");
      out.write(" <hr>\n");
      out.write(" <form name=\"joinform\" method=\"post\" onsubmit=\"return check_id();\" action=\"/join/join_action.jsp\" >\n");
      out.write(" <table style=\"border: 0px;\">\n");
      out.write(" <tr>\n");
      out.write(" <td>아이디 입력</td><td><input type=\"email\" name=\"id\" size=\"70\" placeholder=\"아이디를 입력해 주세요.\" class=\"form-control input-shadow\" style=\"width: 88.4%; display:inline; \"><input type=\"button\" onclick=\"idCheck()\" value=\"중복확인\"><br>\n");
      out.write(" <input type=\"text\" name=\"join_name\" readonly=\"readonly\" style=\"border: 0px; background-color: white; width:210px; height: 33px;\" class=\"form-control input-shadow\">\n");
      out.write(" </td>\n");
      out.write(" </tr>\n");
      out.write(" <tr>\n");
      out.write(" <td>비밀번호 입력</td><td><input type=\"password\" name=\"user_pw\" size=\"70\" placeholder=\"비밀번호를 입력해 주세요.\" class=\"form-control input-shadow\"></td>\n");
      out.write(" </tr>\n");
      out.write("  <tr>\n");
      out.write(" <td></td><td><input type=\"password\" name=\"user_pw_ck\" size=\"70\" placeholder=\"비밀번호를 재확인해 주세요.\" class=\"form-control input-shadow\"></td>\n");
      out.write(" </tr>\n");
      out.write("  <tr>\n");
      out.write(" <td></td><td><lable>8~20자의 영문,숫자,특수문자 조합입니다.</lable></td>\n");
      out.write(" </tr>\n");
      out.write(" <tr>\n");
      out.write("  <td>이 름</td><td><input type=\"text\" name=\"user_name\" size=\"70\" placeholder=\"이름을 입력해 주세요.\" maxlength=\"13\" class=\"form-control input-shadow\"></td>\n");
      out.write("  </tr>\n");
      out.write("  <tr>\n");
      out.write("   <td>휴대폰 번호</td><td><input type=\"text\" name=\"user_tel\" size=\"70\" placeholder=\"000-0000-0000\" maxlength=\"13\" class=\"form-control input-shadow\"></td>\n");
      out.write("  </tr>\n");
      out.write("  <tr>\n");
      out.write("    <td>거주지</td><td><input type=\"text\" name=\"user_address\" size=\"70\" placeholder=\"거주지를 입력해 주세요.\" class=\"form-control input-shadow\"></td>\n");
      out.write("  </tr>\n");
      out.write("  <tr>\n");
      out.write("  <td>나의 다짐</td><td><input type=\"text\" name=\"user_promise\" size=\"70\" placeholder=\"나의 다짐입력\" maxlength=\"50\" class=\"form-control input-shadow\"></td>\n");
      out.write("  </tr>\n");
      out.write("      <tr>\n");
      out.write(" <td></td><td><lable>ID/PW 분실 시 가입정보를 통해 찾을 수 있으므로 정확히 입력해 주시기 바랍니다.</lable></td>\n");
      out.write(" </tr>\n");
      out.write("  </tr>\n");
      out.write("  <tr>\n");
      out.write("  </tr>\n");
      out.write("  <tr>\n");
      out.write("  <td></td>\n");
      out.write("  <td><div class=\"text-right\"><button type=\"submit\">가입완료</button></div></td>\n");
      out.write("  </tr>\n");
      out.write("  </table>\n");
      out.write("  \n");
      out.write("  </form>\n");
