...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <%
    ...
    String sql = "select user_password from user where user_id = ? and user_tel = ?";

    String s_Search="비밀번호를 찾았습니다.";
    String s_pw="비밀번호는 : ";
...
if(user_password == null){
  user_password = "일치하는 정보가 없습니다.";
  b_Search = false;
}
if(b_Search == false){
  s_Search = "비밀번호를 찾지 못하였습니다.";
  s_pw="";
}
%>
...
<body>
  ...
  <main id="main">
    ...
    <div class="container contact">
      ...
      <label><% out.print(s_pw);out.print(user_password); %></label><br>
      <table  width="100%" style="border: 0px;"> 
        <tr>
   
       <% if(b_Search ==false){%>
         <td><div class="text-center"><button type="button" onClick="location.href='/login/login_pw.jsp'">다시 입력</button></div</td>
          <% } %>
