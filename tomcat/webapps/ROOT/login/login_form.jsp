  ...
  <main id="main">
   <br><br>
  	<div class="container contact">
  		<form name="login_form" method="post" action="/login/login_action.jsp">
  			<div class="row content">
  				<div class="col-lg-6"><h2>로그인</h2></div>
  			</div><br><br>
  		...
  		<hr>
  		<div class="logon_option">
  			<a href="javascript:void(window.open('/login/login_id.jsp', '아이디 찾기','width=920px, height=600px'))">아이디 찾기</a>| 
  		  	<a href="javascript:void(window.open('/login/login_pw.jsp', '비밀번호 찾기','width=920px, height=600px'))">비밀번호 찾기</a>|
  		  	<a href="/join/join_form.jsp">회원가입</a>
  		</div>
  	</div>
  </main><!-- End #main -->
