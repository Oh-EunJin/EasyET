...
<main id="main">
 ...
 <div class="container contact">
    <form name="login_id_form" method="post" action="/login/login_pw_action.jsp">
    <h5>비밀번호 찾기</h5>
    <table style="border: 0px;"> 
    <tr>
    <td>아이디</td><td><input type="text" name="user_id" size="50" placeholder="아이디를 입력해 주세요." class="form-control input-shadow"></td>
    </tr>
    <tr>
